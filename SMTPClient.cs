...
namespace ApiFilm
{
    internal class SendEmailByGmail
    {
        ...
        {
            var formattedMessage = textMessage.Replace("\n", "<br/>").Replace("\r", "");
            try
            {
                ...
                <head>
                    <style>
                        ...
                        .highlight {{ background-color: #e8f0fe; padding: 15px; border-left: 4px solid #1a73e8; border-radius: 5px; margin: 1em;}}
                ...
                <body>
                    <div class='container'>
                        <h2>Привет!</h2>
                        <p>Это письмо с данными о фильме которые ты искал</p>
                        <div class='highlight'>
